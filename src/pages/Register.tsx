      ...
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-xs text-muted-foreground mt-2">
            This can take a few minutes to arrive, especially the first time — no need to worry yet.
          </p>
        </div>
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div className="text-xs text-amber-800 dark:text-amber-300 space-y-1">
              ...
              <ul className="list-disc pl-4 space-y-0.5">
                <li>Some inboxes take <strong>20–30 minutes</strong> to receive it the first time — it's very likely just on its way</li>
                <li>Check your <strong>spam/junk</strong> folder in case it's already arrived there</li>
                <li>Still nothing after a while? Tap <em>Resend code</em> above</li>
              </ul>
            </div>
          </div>

          {/* Google sign-in — promoted to a real button, not a buried link,
              since it skips email OTP delivery entirely and is the
              fastest way through this for anyone who doesn't want to wait. */}
          <Button
            variant="outline"
            onClick={() => { setStep('form'); setEmailOtp(''); handleGoogle(); }}
            disabled={googleLoading}
            className="w-full h-10 rounded-xl gap-2 text-sm bg-background"
          >
            {googleLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : (
              <>
                ...
                Skip this — Continue with Google instead
              </>
            )}
          </Button>
