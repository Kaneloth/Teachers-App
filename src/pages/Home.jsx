...
export default function Home() {
  const { data: educators = [] } = useQuery({
    ...
    queryFn: () => base44.entities.Educator.list('-created_date', 20),
  });

  const activeCount = educators.filter(e => e.is_actively_looking).length;
  const provinceCount = new Set(educators.map(e => e.current_province)).size;
    ...
    <div className="px-4 pt-6">
      ...
      <div className="mb-6">
        ...
        <div className="space-y-3">
          ...
          {educators.filter(e => e.is_actively_looking).length === 0 && (
